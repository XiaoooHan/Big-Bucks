...
import com.ibm.security.appscan.altoromutual.model.HistoricalData;
...
public class ChartAPI {
    ...
    private static XYDataset createDataset(String symbol, int year) {
        ...
        try {
            hs = DBUtil.getHistoricalDataByRange(symbol, year);
    ...
    public static XYDataset getReturnDataset(String symbol, int year) {
        ...
        try {
            historicalData = DBUtil.getHistoricalDataByRange(symbol,year);
        } catch (SQLException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private static XYDataset getCumReturnDataset(String symbol, int year) {
        ...
        try {
            stockData = DBUtil.getHistoricalDataByRange(symbol,year);
            indexData = DBUtil.getHistoricalDataByRange("SPY", year);
        } catch (SQLException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
